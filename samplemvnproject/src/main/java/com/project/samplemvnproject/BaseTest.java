...
public class BaseTest {
	...
	public void waitForElement(WebElement elementToBeLocate,int timeInSeconds) {
		WebDriverWait wait=new WebDriverWait(driver, timeInSeconds);
		wait.until(ExpectedConditions.elementToBeClickable(elementToBeLocate));
	}
	...
	public void selectDOB(WebElement elementOfDOB, int index) {
		Select s=new Select(elementOfDOB);
